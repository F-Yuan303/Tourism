...
> **Live site: [f-yuan303.github.io/Tourism](https://f-yuan303.github.io/Tourism/)**
...
```text
Tourism/
├── index.html                    # New Zealand South Island trip map
├── trips/tokyo-2026-10/
│   ├── index.html                # Tokyo five-day trip map
│   └── plan.md                   # Route notes and checks
├── README.md                     # Chinese project guide and page directory
└── README_EN.md                  # English project guide and page directory
```

As new trips are added, each page will receive its own path and both language directories will be updated.

## Links

- **Live site:** https://f-yuan303.github.io/Tourism/
- **GitHub repository:** https://github.com/F-Yuan303/Tourism
